...
import gc
dataset_path =           (".\\_PolicyProject2_public\\_trained_models_env5\\_teach1_dataset")
ckpt_path =              (".\\_PolicyProject2_public\\_trained_models_env5\\model_PolicyProject1_Attention.ckpt")
output_dir =             (".\\_PolicyProject2_public\\_trained_models_env5")
training_loss_csv_path = (".\\_PolicyProject2_public\\_trained_models_env5\\training_loss_Attention.csv")
MinMax_dir_path =        (".\\_PolicyProject2_public\\_trained_models_env5\\MinMax")
...
env = assemble_env_5.AssembleEnv(img_obs_height=img_height, img_obs_width=img_width, img_obs_channel=img_channel,
...
while True:
    ...
    if isUseRandomEnv:
        ...
        # # 假设改变角度
        # env.reset(isAddError=True, is_drag_mode=False, error_scale_pos=4.5, error_scale_ort=2,
        #           initial_pos_ort=np.array([-97.16e-3, -595.25e-3, 130e-3, 0, -3.1415, -1.068]))
    else:
        env.reset(isAddError=False, is_drag_mode=False)
    ...
    # # wandb.log({"max_force":max_force, 'episode':episode})
    # torch.cuda.empty_cache()
    # # print("episode:",episode, "max_force:",max_force)
    # gc.collect()
