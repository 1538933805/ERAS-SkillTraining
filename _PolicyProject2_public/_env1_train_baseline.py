...
ckpt_path =              (".\\_PolicyProject2_public\\_trained_models_env1\\model_PolicyProject1.ckpt")
output_dir =             (".\\_PolicyProject2_public\\_trained_models_env1")
training_loss_csv_path = (".\\_PolicyProject2_public\\_trained_models_env1\\training.csv")
...
vision_encoder = nets.get_resnet('resnet18')
# IMPORTANT!
