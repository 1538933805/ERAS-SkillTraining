...
dataset_path =           (".\\_PolicyProject2_public\\_trained_models_env2\\_teach1_dataset")
ckpt_path =              (".\\_PolicyProject2_public\\_trained_models_env2\\model_PolicyProject1_Attention.ckpt")
output_dir =             (".\\_PolicyProject2_public\\_trained_models_env2")
training_loss_csv_path = (".\\_PolicyProject2_public\\_trained_models_env2\\training_loss_Attention.csv")
MinMax_dir_path =        (".\\_PolicyProject2_public\\_trained_models_env2\\MinMax")
...
while True:
    ...
    isUseRandomEnv = False
    
    env.reset(isAddError=False, is_drag_mode=False)
    if isUseRandomEnv:
        env.reset(isAddError=True, is_drag_mode=False)
    else:
        env.reset(isAddError=False, is_drag_mode=False)
