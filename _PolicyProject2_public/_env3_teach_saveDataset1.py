...
import torch
import keyboard
dataset_path =     (".\\_PolicyProject2_public\\_trained_models_env3\\_teach1_dataset")
dataset_zip_path = (".\\_PolicyProject2_public\\_trained_models_env3\\_teach1_dataset.zip")
dataset_hdf5_path = (".\\_PolicyProject2_public\\_trained_models_env3\\_teach1_dataset.hdf5")
...
env = assemble_env_3.AssembleEnv()
...
if __name__ == '__main__':
    while True:
        ...
        env.reset(isAddError=True, is_drag_mode=is_drag_mode, error_scale_pos=2.5, error_scale_ort=1)
