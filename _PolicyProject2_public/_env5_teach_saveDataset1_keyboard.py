...
dataset_zip_path = (".\\_PolicyProject2_public\\_trained_models_env5\\_teach1_dataset.zip")
dataset_hdf5_path = (".\\_PolicyProject2_public\\_trained_models_env5\\_teach1_dataset.hdf5")
...
env = assemble_env_5.AssembleEnv()
...
if __name__ == '__main__':
    while True:
        ...
        # env.reset(isAddError=True, is_drag_mode=is_drag_mode, error_scale_pos=4, error_scale_ort=3)
        env.reset(isAddError=True, is_drag_mode=is_drag_mode, error_scale_pos=5, error_scale_ort=3)
