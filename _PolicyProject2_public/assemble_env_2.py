...
class AssembleEnv(object):
    def __init__(self, dt = 0., max_steps = 1000,
        ...
        self.task_name = "planetary gear assembly"
        #|o|o|                             observations: 2
        ...
        self.rob.RTDE_SOFT_RETURN = 0.001
    ...
    def reset(self, isAddError=True, is_drag_mode=False, error_scale_pos=0.1, error_scale_ort=0.1,
              initial_pos_ort=np.array([-5.2e-3, -620.85e-3, 92.5e-3, 0, -3.1415, 0])):
    ...
    def step_by_keyboard(self, isPrintInfo=False):
        ...
        max_rotation = 1          # 每步最大旋转范围，单位：deg
        act_step = np.zeros(7)
