...
ckpt_path =              (".\\_PolicyProject2_public\\_trained_models_env2\\model_PolicyProject1_Attention_UsePreTrain.ckpt")
output_dir =             (".\\_PolicyProject2_public\\_trained_models_env2")
training_loss_csv_path = (".\\_PolicyProject2_public\\_trained_models_env2\\training_loss_Attention_UsePreTrain.csv")
...
"可加载预训练权重"
vision_encoder_1 = nets.get_resnet_with_attention('resnet18', weights="IMAGENET1K_V1")
vision_encoder_2 = nets.get_resnet_with_attention('resnet18', weights="IMAGENET1K_V1")
"可选择冻结预训练权重"
