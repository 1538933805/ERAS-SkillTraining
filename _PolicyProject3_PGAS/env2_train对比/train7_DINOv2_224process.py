...
ckpt_path =              (".\\_PolicyProject3_PGAS\\env2_train对比\\7_DINOv2_224process\\model.ckpt")
output_dir =             (".\\_PolicyProject3_PGAS\\env2_train对比\\7_DINOv2_224process")
training_loss_csv_path = (".\\_PolicyProject3_PGAS\\env2_train对比\\7_DINOv2_224process\\loss.csv")
...
vision_encoder_1 = nets_VE1.DINOv2VisionEncoder()
vision_encoder_2 = nets_VE1.DINOv2VisionEncoder()
# "可选择冻结预训练权重"
