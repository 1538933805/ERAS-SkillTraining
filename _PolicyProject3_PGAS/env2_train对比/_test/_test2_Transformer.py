...
ckpt_path =              (".\\_PolicyProject3_PGAS\\env2_train对比\\2_Transformer\\model.ckpt")
output_dir =             (".\\_PolicyProject3_PGAS\\env2_train对比\\2_Transformer")
training_loss_csv_path = (".\\_PolicyProject3_PGAS\\env2_train对比\\2_Transformer\\loss.csv")
max_iterations = 50000  # 目标最大迭代次数

info_path = (".\\_PolicyProject3_PGAS\\env2_train对比\\_test\\2_Transformer\\info.csv")
...
import DiffusionPolicy_Networks_Transformer as nets_trans
...
# )
noise_pred_net = nets_trans.TransformerForDiffusion(
    input_dim=action_dim,
...
with torch.no_grad():
    ...
    "改!  global_cond变cond obs不用flatten"
...
env.rob.RTDE_SOFT_RETURN = 0.003
