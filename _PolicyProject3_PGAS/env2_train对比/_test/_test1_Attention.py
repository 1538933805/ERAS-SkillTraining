...
ckpt_path =              (".\\_PolicyProject3_PGAS\\env2_train对比\\1_Attention\\model.ckpt")
output_dir =             (".\\_PolicyProject3_PGAS\\env2_train对比\\1_Attention")
training_loss_csv_path = (".\\_PolicyProject3_PGAS\\env2_train对比\\1_Attention\\loss.csv")
max_iterations = 50000  # 目标最大迭代次数

info_path = (".\\_PolicyProject3_PGAS\\env2_train对比\\_test\\1_Attention\\info.csv")
