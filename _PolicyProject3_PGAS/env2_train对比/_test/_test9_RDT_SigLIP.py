...
ckpt_path =              (".\\_PolicyProject3_PGAS\\env2_train对比\\9_RDT_SigLIP\\model.ckpt")
output_dir =             (".\\_PolicyProject3_PGAS\\env2_train对比\\9_RDT_SigLIPT")
training_loss_csv_path = (".\\_PolicyProject3_PGAS\\env2_train对比\\9_RDT_SigLIP\\loss.csv")
max_iterations = 50000  # 目标最大迭代次数

info_path = (".\\_PolicyProject3_PGAS\\env2_train对比\\_test\\9_RDT_SigLIP\\info.csv")
