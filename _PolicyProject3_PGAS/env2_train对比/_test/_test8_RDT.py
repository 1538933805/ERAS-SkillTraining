...
ckpt_path =              (".\\_PolicyProject3_PGAS\\env2_train对比\\8_RDT\\model.ckpt")
output_dir =             (".\\_PolicyProject3_PGAS\\env2_train对比\\8_RDT")
training_loss_csv_path = (".\\_PolicyProject3_PGAS\\env2_train对比\\8_RDT\\loss.csv")
max_iterations = 50000  # 目标最大迭代次数

info_path = (".\\_PolicyProject3_PGAS\\env2_train对比\\_test\\8_RDT\\info.csv")
