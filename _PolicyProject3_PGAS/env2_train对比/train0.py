...
ckpt_path =              (".\\_PolicyProject3_PGAS\\env2_train对比\\0\\model.ckpt")
output_dir =             (".\\_PolicyProject3_PGAS\\env2_train对比\\0")
training_loss_csv_path = (".\\_PolicyProject3_PGAS\\env2_train对比\\0\\loss.csv")
