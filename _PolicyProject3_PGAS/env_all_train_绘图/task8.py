...
MAX_X_LENGTH = 59000      # Maximum data length to plot (truncate if longer)
...
# Paths and names
paths_list = [
    [".\\_PolicyProject4_public2\\env1_train对比\\3_VE_mobileViT1\\loss.csv", 1],
]
paths = [item[0] for item in paths_list]
output_path = ".\\_PolicyProject3_PGAS\\env_all_train_绘图\\figs\\task8.png"
