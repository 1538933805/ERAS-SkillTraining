...
ckpt_path =              (".\\_PolicyProject3_PGAS\\_trained_models_env3\\model_PolicyProject1_Attention000.ckpt")
output_dir =             (".\\_PolicyProject3_PGAS\\_trained_models_env3")
training_loss_csv_path = (".\\_PolicyProject3_PGAS\\_trained_models_env3\\training_loss_Attention000.csv")
                ...
                with tqdm(dataloader, desc='Batch', leave=False) as tepoch:
                    for batch_idx, nbatch in enumerate(tepoch):
                        try:
                            ...
                            print("nimage_1.shape:\t",nimage_1.shape)
                            ...
                            print("nimage_1.flatten后的shape:\t", nimage_1.flatten(end_dim=1).shape)
                            print("image_features_1.shape:\t", image_features_1.shape)
                            image_features_1 = image_features_1.reshape(
                                *nimage_1.shape[:2],-1)
                            B = image_features_1.shape[0]
                            print("nimage_1.shape[:2]", nimage_1.shape[:2])
                            print("image_features_1.shape:\t", image_features_1.shape)
                            # (B,obs_horizon,D)
