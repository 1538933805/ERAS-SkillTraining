...
ckpt_path =              (".\\_PolicyProject3_PGAS\\env1_train对比\\6_VE_SigLIP2\\model.ckpt")
output_dir =             (".\\_PolicyProject3_PGAS\\env1_train对比\\6_VE_SigLIP2")
training_loss_csv_path = (".\\_PolicyProject3_PGAS\\env1_train对比\\6_VE_SigLIP2\\loss.csv")
batch_reduce = 8 # GPU不足时,batch_size缩小倍数
max_iterations = 50000 * batch_reduce  # 目标最大迭代次数
"记录标记!"
"记录标记!"
# 测试参数配置
test_result_path = "./_PolicyProject3_PGAS/env1_train对比/_网络性能/6_VE_SigLIP/network_performance.txt"  # 测试结果保存路径
