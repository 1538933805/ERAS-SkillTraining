...
ckpt_path =              (".\\_PolicyProject3_PGAS\\env1_train对比\\10_RDT_mobileViT\\model.ckpt")
output_dir =             (".\\_PolicyProject3_PGAS\\env1_train对比\\10_RDT_mobileViT")
training_loss_csv_path = (".\\_PolicyProject3_PGAS\\env1_train对比\\10_RDT_mobileViT\\loss.csv")
max_iterations = 50000  # 目标最大迭代次数

info_path = (".\\_PolicyProject3_PGAS\\env1_train对比\\_test\\10_RDT_mobileViT\\info.csv")
