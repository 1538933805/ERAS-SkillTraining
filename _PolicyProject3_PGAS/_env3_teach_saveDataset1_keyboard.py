...
dataset_zip_path =  (".\\_PolicyProject3_PGAS\\_trained_models_env3\\_teach1_dataset.zip")
dataset_hdf5_path = (".\\_PolicyProject3_PGAS\\_trained_models_env3\\_teach1_dataset.hdf5")
...
if __name__ == '__main__':
    while True:
        ...
        env.reset(isAddError=True, is_drag_mode=is_drag_mode, error_scale_pos=1, error_scale_ort=1)
