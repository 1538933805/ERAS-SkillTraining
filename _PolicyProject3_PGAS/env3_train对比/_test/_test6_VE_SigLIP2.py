...
ckpt_path =              (".\\_PolicyProject3_PGAS\\env3_train对比\\6_VE_SigLIP2\\model.ckpt")
output_dir =             (".\\_PolicyProject3_PGAS\\env3_train对比\\6_VE_SigLIP2")
training_loss_csv_path = (".\\_PolicyProject3_PGAS\\env3_train对比\\6_VE_SigLIP2\\loss.csv")
max_iterations = 50000  # 目标最大迭代次数

info_path = (".\\_PolicyProject3_PGAS\\env3_train对比\\_test\\6_VE_SigLIP2\\info.csv")
