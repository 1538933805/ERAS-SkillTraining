...
MOVING_AVG_WINDOW = 500   # Window size for moving average
MAX_X_LENGTH = 49000      # Maximum data length to plot (truncate if longer)
X_LIM = (0, 48000)        # x-axis limits (after downsampling if applied)
Y_LIM = (0, 0.4)          # y-axis limits
...
# Paths and names
paths_list = [
    [".\\_PolicyProject3_PGAS\\env3_train对比\\2_Transformer\\loss.csv", 0],
    [".\\_PolicyProject3_PGAS\\env3_train对比\\1_Attention\\loss.csv", 0],
    [".\\_PolicyProject3_PGAS\\env3_train对比\\6_VE_SigLIP2\\loss.csv", 0],
    [".\\_PolicyProject3_PGAS\\env3_train对比\\3_VE_mobileViT1\\loss.csv", 1],
    [".\\_PolicyProject3_PGAS\\env3_train对比\\9_RDT_SigLIP\\loss.csv", 1],
    [".\\_PolicyProject3_PGAS\\env3_train对比\\10_RDT_mobileViT\\loss.csv", 1]
]
paths = [item[0] for item in paths_list]
output_path = ".\\_PolicyProject3_PGAS\\env3_train对比\\_draw1\\4pics\\loss_comparison1.png"
