...
#@markdown ### **Imports**
# file import
from _PolicyProject4_public2 import assemble_env_1
...
"记录标记!"
dataset_path =           (".\\_PolicyProject4_public2\\_trained_models_env1\\_teach1_dataset_amplify1")
MinMax_dir_path =        (".\\_PolicyProject4_public2\\_trained_models_env1\\MinMax")

ckpt_path =              (".\\_PolicyProject4_public2\\env1_train对比\\3_VE_mobileViT1\\model.ckpt")
output_dir =             (".\\_PolicyProject4_public2\\env1_train对比\\3_VE_mobileViT1")
training_loss_csv_path = (".\\_PolicyProject4_public2\\env1_train对比\\3_VE_mobileViT1\\loss.csv")
max_iterations = 50000  # 目标最大迭代次数

info_path = (".\\_PolicyProject4_public2\\env1_train对比\\_test\\3_VE_mobileViT1\\info.csv")
...
env.rob.RTDE_SOFT_F_THRESHOLD = 10
...
for episode in range(20):
    ...
    angle_deg = (episode % 10) * 45
    angle_rad = np.deg2rad(angle_deg)
    # Calculate position offset (1cm radius)
    pos_offset = 0.005  # in meters
