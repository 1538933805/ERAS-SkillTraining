...
ckpt_path = (".\\_PolicyProject1\\_trained_models_env1\\model_PolicyProject1_Attention.ckpt")
...
while True:
    ...
    if isUseRandomEnv:
        env.reset(isAddError=True, is_drag_mode=False, error_scale_pos=1)
    else:
        env.reset(isAddError=False, is_drag_mode=False, error_scale_pos=1)
